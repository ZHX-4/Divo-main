              ...
              <div className={`pt-4 pb-3 border-t ${theme === 'dark' ? 'border-gray-700' : 'border-gray-200'}`}>
                {!isAuthenticated ? (
                  <div className="mt-3 space-y-1">
                    ...
                    <Link 
                      href="/register" 
                      className={`block px-4 py-2 text-base font-medium ${theme === 'dark' ? 'text-white-200 hover:bg-gray-700 hover:text-white' : 'text-gray-600 hover:bg-gray-50 hover:text-white-800'}`}
                    >
                      Sign up 
                    </Link>
                  </div>
                  ...
                  <div className="flex items-center px-4">
                    <div className="flex-shrink-0">
                      <img
                        ...
                        src="../../../public/images/patients/patient-4.png"
                        alt=""
                      />
                    </div>
                    <div className="ml-3">
