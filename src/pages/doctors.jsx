...
const MOCK_DOCTORS = [
  {
    ...
    bio: 'Dr. Sarah is a board-certified cardiologist with over 15 years of experience in treating heart conditions.',
    availability: {
  ...
  {
    id: '2',
    name: 'Dr. Madara Zenen',
    specialty: 'Dermatology',
    rating: 4.8,
    experience: 10,
    education: ['University School of Medicine', 'MEDU'],
    languages: ['English', 'Arabic','French'],
    bio: 'Dr. Madara specializes in medical and cosmetic dermatology, with a focus on skin cancer prevention and treatment.',
    availability: {
  ...
  },
  {
    ...
    rating: 4.9,
    experience: 12,
    education: ['School of Medicine', 'University of medicine'],
    languages: ['English', 'French', 'Arabic'],
    bio: 'Dr. Amel is a compassionate pediatrician dedicated to providing comprehensive care for children from birth through adolescence.',
    availability: {
